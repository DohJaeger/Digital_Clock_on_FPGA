...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets CENT_BTN_IBUF]
# Switches
set_property PACKAGE_PIN V17 [get_ports {SET_CLK_SWITCH}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {SET_CLK_SWITCH}]
set_property PACKAGE_PIN V16 [get_ports {ALARM_SWITCH}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ALARM_SWITCH}]
set_property PACKAGE_PIN W16 [get_ports {ALARM_ON}]					
...
set_property PACKAGE_PIN T1 [get_ports {STOP_WATCH_SWITCH}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {STOP_WATCH_SWITCH}]
set_property PACKAGE_PIN R2 [get_ports {STOP_WATCH_ON}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {STOP_WATCH_ON}]
 

# LEDs
set_property PACKAGE_PIN U16 [get_ports {SET_CLK_LED}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {SET_CLK_LED}]
set_property PACKAGE_PIN E19 [get_ports {ALARM_LED}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ALARM_LED}]
set_property PACKAGE_PIN U19 [get_ports {SET_STOPWATCH_LED}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {SET_STOPWATCH_LED}]
#set_property PACKAGE_PIN V19 [get_ports {sum3}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {sum3}]
#set_property PACKAGE_PIN W18 [get_ports {carry3}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {carry3}]
...
set_property PACKAGE_PIN V3 [get_ports {Hours[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Hours[0]}]
set_property PACKAGE_PIN W3 [get_ports {Hours[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Hours[1]}]
set_property PACKAGE_PIN U3 [get_ports {Hours[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Hours[2]}]
set_property PACKAGE_PIN P3 [get_ports {Hours[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Hours[3]}]
set_property PACKAGE_PIN N3 [get_ports {Hours[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Hours[4]}]
set_property PACKAGE_PIN P1 [get_ports {Hours[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Hours[5]}]
...
##Buttons
set_property PACKAGE_PIN U18 [get_ports CENT_BTN]						
	set_property IOSTANDARD LVCMOS33 [get_ports CENT_BTN]
